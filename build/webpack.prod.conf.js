...
const copyConfig = [
  {
    // @@@todo
    from: path.resolve(__dirname, `../${sourcePath}/static`),
  ...
  },
  {
    ...
    ignore: utils.ifFrontMode() ? ['index.html'] : [],
  },
  {
...
const globalVariables = fs.readFileSync(`${__dirname}/globalVariables/prod.js`, 'utf8');
