...
(function($) {
  ...
  $.fn.extend({
    ...
    insertArCaret: function(jqobj, html) {
      ...
      // 话术编辑器
        ...
        richEditor.bindEvent(_style, /*$.utils._speechcraftContentVue.isDisabled*/ false);
      }
  ...
  $.extend($.utils, {
    ...
    _knowledgeStrategySwitch: '0',
    _strategyTriggerCondition: '',
    _knowledgePlayFlowType: '',
    _preCallServices: '',
    _lastCallServices: '',
    // 话术内容Vue实例
    ...
    createDialogVue: function() {
      return new Vue({
        ...
        data: {
          ...
          preUseFlowRobotNodes: '',
          preUseFlowRobotNodesXml: '',
          nextIgnore: false,
        ...
        methods: {
          ...
          changeNoticeUse() {
            mxEditor.hideProperties();
            showFlowDiagram(this.preUseFlowRobotNodesXml);
            this.initFlowRobotNodesJson = this.preUseFlowRobotNodes;
          ...
          querySpeechcraftDetail() {
            ...
            $.post(`${baseHost}/services/scheme/querySchemeList.json`)
              .then(res => {
              ...
              .then(res => {
                if (res.resultMessageEnum === '0000') {
                  ...
                  const speechcraftTypeItem = speechcraftTypeList.filter(
                    item => parseInt(item.schemeType) === data.speechcraftType,
                  );
          ...
          handlePlaying() {
            ...
            if (self.videoPlay) {
              ...
              const payload = {
                ...this.splitAuditionData,
                audios: this.splitAuditionData.audios.filter(({ text, url }) => Boolean(text || url)),
              };
              $.ajax({
                type: 'POST',
                ...
                success: function(data) {
                  ...
                  if (data.resultMessageEnum == '0000') {
                    self.viewSource =
                      baseHost + '/services/file/downloadFile.html?filePath=' + data.returnObject.joinUrl;
          ...
          percentMusic() {
            ...
            this.$refs.w_audio.ontimeupdate = () => {
              this.currentMusic.duration = this.$refs.w_audio.duration;
          ...
          resetCheckedList(val) {
            ...
            const checkedList = $.utils._checkedList.filter(function(element, index, self) {
              return element !== val;
            });
          ...
          nochangeJumpConfirm() {
            ...
            try {
              ...
              // reset currentCell
              graph.removeCellOverlays(currentCell);
              currentCell.setStyle('answer');
              currentCell.setAttribute('jumpItemType', '');
              ...
              graph.insertEdge(parent, null, mxEditor.templates.edge.value, currentCell, v1, 'straightEdge');
              // var removeIds = [];
              // for (var i in sourceCell.edges){
            ...
            // 通知取消话术跳转
            $(document).trigger('nochangeJumpConfirm');
          },
