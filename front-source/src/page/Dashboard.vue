                ...
                <el-col :span="14">
                    <el-card>
                        ...
                        <div class="remaining_calls">
                            <el-progress :width="76" height="76" color="#12D4A3" type="circle" v-if="taskInfo.percentage" :percentage="taskInfo.percentage<0?0:taskInfo.percentage"  ></el-progress>
                            <div class="remaining_calls_right">
                                ...
                                <span class="remaining_calls_right_bottom">剩余呼叫次数:{{taskInfo.percentage}}</span>
                            </div>
                        </div>
...
//            this.queryTaskIntentionByTaskId()
        ...
        methods: {
            ...
            handleCommandType2(command) {
                ...
                console.log('dropdown_text_Type2: ', this.dropdown_text_Type2)
            },
            ...
            queryTaskIntentionByTaskId(){
                ...
                $.get(this.$baseUrl + 'task/queryTaskIntentionByTaskId.json?speechcraftId=' + this.speechcraftId
                    ...
                    if (res.resultMessageEnum == '0000') {
                        ...
                        this.chartYTFNData["rows"] = sortBy(rows, ['日期'])
                        this.countA = counta
                        this.countB = countb
                        this.countC = countc
                        this.countD = countd
