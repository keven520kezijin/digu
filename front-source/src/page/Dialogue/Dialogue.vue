...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async filter() {
                if (this.select_date <= 0 && !this.select_channel_name && !this.searchDialogueName) {
            ...
            async fetchList() {
                ...
                if (this.select_date && this.select_date.length > 0) {
                    ...
                    if (endTime) params.dialogEndTime = moment(endTime).set("hours", 23).set("minutes", 59).set("seconds", 59).format("YYYY-MM-DD HH:mm:ss");
                }

                // 渠道
                if (this.select_channel_name) {
                    params.channelName = this.select_channel_name;
                }
                ...
                this.dialogueDataList.forEach(item => {
                    if (item.channelName && this.channelList.indexOf(item.channelName) < 0) {
