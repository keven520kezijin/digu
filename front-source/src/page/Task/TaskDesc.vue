                    ...
                    >
                        ...
                        <el-table-column label="识别详情" width="100" align="center">
                            <template slot-scope="scope">
                                <el-button :disabled="scope.row.connectedResultType!=1" type="text" @click="handleResulyRecognitionClick(scope.$index, scope.row)">查看</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleResulyRecognitionClick(_, row) {
                this.$router.push(`/taskRecognition/${row.id}?sname=${this.$route.query.sname}`)
            },
            // 2.8.6.查看识别详情
