  ...
  <div class="block">
    <div class="batch-group">
      ...
      <div class="content-group">
        ...
        <div class="content">
          <div class="content-item">请下载用于修改知识库问答的Excel模版文件</div>
    ...
    export default {
        ...
        methods: {
            ...
            async uploadFile() {
                ...
                const { data } = await axios.post(`${this.$baseUrl}knowledge/batchModifyKnowledge.json`, param);
                if (data.resultMessageEnum !== API_SUCCESS_CODE) {
                    this.$message.error('批量修改知识库失败');
                    return;
                }
            ...
            async downloadTemplate() {
                const { data } = await axios.post(`${this.$baseUrl}knowledge/exportKnowledgeListTemplateExcel.json`, this.batchEditGroupNames);
                if (data.resultMessageEnum == '0000') {
                    window.location.href = this.$baseUrl + 'file/downloadFile.html?filePath=' + data.returnObject.filePath;
