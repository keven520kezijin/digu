            ...
            <div class="right-menu-box">
                ...
                <!--<el-tooltip content="移动" placement="top" effect="light">-->
                    <!--<span class="repository-btn-move">-->
                        <!--<el-button icon="iconfont icon-icon_move" :disabled="!multipleSelection.length"></el-button> &ndash;&gt;-->
                         <!--<i class="iconfont icon-icon_move blue"></i> &ndash;&gt;-->
                        <!--<el-cascader-->
...
<script>
    ...
    export default {
        ...
        async created() {
            ...
            await this.queryKnowledgeItemList();
        ...
        methods: {
            ...
            handleExport() {
                if (this.multipleSelection.length === 0) {
                 ...
                 $.post(
                     this.$baseUrl + 'knowledge/batchExportKnowledgeItemExcelFile.json',
            ...
            handleInputConfirm() {
                ...
                if (inputValue) {
                    ...
                    if (this.sigleKnowledgeData.keyWords === "") {
                        this.sigleKnowledgeData.keyWords = []
                    }
			...
			modifyKnowledgeItem() {
				...
				if (flag) {
                    ...
                    // 是新增问答
                    if(this.isAddForm) {
                        const addData = { ...baseData, groupId: this.groupId, groupName: this.groupName }
            ...
            addSimilerQuestion() {
                if(!this.sigleKnowledgeData.questionContentOther[this.sigleKnowledgeData.questionContentOther.length - 1].value) return;
            ...
            async queryKnowledgeItemList(){
                ...
                const res = await $.post(this.$baseUrl+'knowledge/queryKnowledgeItemList.json',JSON.stringify(params))
                if(res.resultMessageEnum=='0000'){
                    let data = res.returnObject && res.returnObject.recordList;
                    if(data){
                        ...
                        this.knowledgeData = data.filter(d => !!d.questionContent);
