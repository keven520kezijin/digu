  ...
  <div class="container-admin">
    ...
    <div class="admin-body">
      ...
      >
        <el-table-column prop="industryName" label="行业名称">
          <template slot-scope="scope">
            ...
            <el-input
              ...
              v-show="industryActiveName == 'second' && scope.row.isEdit"
            ></el-input>
          </template>
        </el-table-column>
        <el-table-column prop="industryStatus" label="行业状态" width="180">
          <template slot-scope="scope">
        ...
        <el-table-column prop="latestPublishDate" label="上线时间" sortable width="180"> </el-table-column>
      ...
      >
        ...
        <el-table-column prop="latestOfflineDate" label="下线时间" sortable width="180"> </el-table-column>
        <el-table-column prop="creator" label="操作人" width="180"> </el-table-column>
        <el-table-column width="180" label="操作">
          <template slot-scope="scope">
            <div class="">
              <div>
                <span v-if="scope.row.isEdit">
                  <el-button type="text" class="warning" @click="handleEditCancel(scope.$index, scope.row)"
                    >取消</el-button
                  >
                  ｜
    ...
    <el-dialog title="下线行业" :visible.sync="offlineVisible" width="400px">
      <div v-if="notFinishNum > 0">
        该行业下有{{
          notFinishNum
        }}个任务正在执行中，点击“确认”后，该行业将进入“停用”状态，该状态下任务将正常进行，但该行业相关话术不可再用
      </div>
    ...
    <el-dialog title="批量删除行业" class="addQuestion" :visible.sync="delIndustryVisible" width="400px">
      <div>您确定要删除已选中的{{ this.multipleSelection.length }}个行业吗？</div>
      <span slot="footer" class="dialog-footer">
  ...
  data() {
    return {
      ...
      addIndustryFormRules: {
        industryName: [{ required: true, message: '输入行业名称' }],
      },
      pagination: {
        show: true,
        total: 0,
