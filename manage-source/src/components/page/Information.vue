    ...
    <div class="admin-body">
      <el-row class="search-box">
        <el-form :inline="true" ref="searchForm" :model="searchForm" class="demo-form-inline">
          ...
          <el-form-item label="付费">
            <el-select @change="typeChange" v-model="searchForm.freeFlag" placeholder="全部">
          ...
          <el-form-item label="认证">
            <el-select @change="typeChange" v-model="searchForm.authenticationFlag" placeholder="所有">
      ...
      <div class="information-data-box">
        <el-table ref="multipleTable" :data="tableData" style="width: 100%" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="用户名称" prop="enterpriseName">
          ...
          <el-table-column prop="accountName" label="注册手机号" width="340"> </el-table-column>
