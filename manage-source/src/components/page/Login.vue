    ...
    <div class="login-right">
      <div class="login-right-body">
        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0px" class="ms-content">
          <div v-if="errors.errorMsg" class="login_error el-form-item__error">
            该手机号尚未注册，<a href="#/registered">点击注册</a>。
          </div>
          <el-form-item prop="username">
            <!-- <span>该手机号尚未注册，点击注册</span> -->
            <el-input placeholder="手机号" v-model="ruleForm.username">
          ...
          <el-form-item prop="password">
            ...
            >
              ...
              <i
                slot="suffix"
                class="el-input__icon iconfont icon-ico_invisible"
                :class="passwordClass"
          ...
          <el-form-item prop="img_code" v-show="codeValid">
            <el-input placeholder="图形密码" v-model="ruleForm.img_code">
...
export default {
  ...
  methods: {
    ...
    querySelfDetail() {
      ...
      let GLOBAL_realName = '';
      $.get(this.$baseUrl + 'services/manager/querySelfDetail.json')
        .then(res => {
          if (res.resultMessageEnum == '0000') {
