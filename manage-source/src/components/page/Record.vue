      ...
      <el-card class="record-box-card">
        ...
        <div class="yt">
          <el-row class="tj-header">
            <el-col :span="4"
              ><i class="a">A</i><span>{{ statisData.A }}</span
              >通</el-col
            >
            <el-col :span="4"
              ><i class="b">B</i><span>{{ statisData.B }}</span
              >通</el-col
            >
            <el-col :span="4"
              ><i class="c">C</i><span>{{ statisData.C }}</span
              >通</el-col
            >
            <el-col :span="4"
              ><i class="d">D</i><span>{{ statisData.D }}</span
              >通</el-col
            >
            <el-col :span="4"
              ><i class="e">E</i><span>{{ statisData.E }}</span
              >通</el-col
            >
            <el-col :span="4"
              ><i class="f">F</i><span>{{ statisData.F }}</span
              >通</el-col
            >
          </el-row>
        </div>
...
export default {
  ...
  methods: {
    ...
    queryTaskItemStatisticsKpiData(opt) {
      ...
      $.post(this.$baseUrl + 'services/statistics/queryTaskItemStatisticsKpiData.json', JSON.stringify(newData)).then(
        res => {
