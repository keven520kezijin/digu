                ...
                <el-form :model="atchKnow" :rules="atchKnowRules" ref="atchKnow" label-width="100px" class="demo-ruleForm">
                    ...
                    <div class="updload-list-box">
                        <el-button class="file-btn" v-show="!atchKnow.errorMessage">
                            <el-input multiple="multiple" class="file-btn-inner-input" v-model="atchKnow.filePath" type="file" id="file" @change="uploadAnnexFile('file')"></el-input>
                            选择文件上传
                        </el-button>
                    ...
                    <div v-for="(item,index) in correctArry" :key="index" v-show="item.nextUpload">
                        ...
                        <div class="updload-list-box" >
                            <el-button class="file-btn" v-show="!item.errorMessage">
                                <el-input multiple="multiple" class="file-btn-inner-input" v-model="item.filePath" type="file" :id="item.id" @change="uploadAnnexFile(item.id)"></el-input>
                                选择文件上传
                            </el-button>
...
//                        this.$refs.multipleMatchTable.clearSelection()
            ...
            handleCreatFAQV(){
                this.$router.push(`/repository/config/${this.$route.params.id}/add`)
                // this.creatFAQVForm = {
                //     questionContent:'',
                //     questionContentOther: [{
                //         name:'相似问题',
