  ...
  <div class="table">
    ...
    <!-- <div class="content-box-top">
            ...
            <div class="content-box-top-right">
                <el-button type="primary" icon="el-icon-circle-plus-outline" @click="creatFAQVisible = true">新建问答22</el-button>
            </div>
        </div> -->
        ...
        <div class="repository-edit-box">
          <el-form :model="editForm" :rules="editRules" ref="editForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-row>
              <el-col :span="12">
                <div class="w__header">
                  <span class="left w_rell"
                    >相似问题<i v-if="!readonly" class="iconfont icon-ico_add" @click="addQustion"></i
                  ></span>
                ...
                <div class="w__body left">
                  <div
                    ...
                    v-for="(item, index) in questionContentOther"
                    :key="index"
                  >
                  ...
                  >
                    ...
                    >
                      <div class="rep-edit-top">
                        <i v-if="!readonly"
                          >您可以<span class="link" @click="handleUseAudio">使用音频</span
                          >（使用后将自动填充对应文本）或
                          <span class="link"
                            >上传音频<input
                              type="file"
                              multiple="multiple"
                              class="importFile"
                              @change="uploadAnnexFileOfInfo(item, index)"/></span
                        ></i>
                        <div class="canel-box">
