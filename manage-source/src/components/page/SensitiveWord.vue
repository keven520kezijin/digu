      ...
      <el-row class="first-row">
        ...
        <el-col>
          <el-table :data="dataList" @selection-change="handleSelectionChange" @cell-click="enterModify">
            ...
            <el-table-column label="词库名称">
              <template slot-scope="{ row, $index }">
                <span :id="row.id + ext">{{ row.libraryName }}</span>

                <span :id="row.id" style="display: none">
                  <el-input
                    @keyup.native.13="confirmChangeLibraryName(row)"
                    v-model="currentModifyOldLibraryName"
                    style="width: 200px"
                  ></el-input>
                  <span>
                    <el-button
          ...
          <el-dialog title="新增敏感词库" :visible.sync="addNewLibary" width="30%">
          ...
          <el-dialog title="删除敏感词库" :visible.sync="delVisible" width="30%">
