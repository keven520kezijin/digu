      ...
      <div class="overrule-dialog-cnt">
        <el-form ref="formOverruleForm" :model="formOverrule" label-width="90px">
          <el-form-item
            ...
            :error="errors.formOverruleDesc"
          >
            <el-checkbox-group v-model="formOverrule.type" @change="changeCheckbox">
              <el-checkbox v-for="(item, index) in checkboxList" :key="index" :label="item" name="type"> </el-checkbox>
            </el-checkbox-group>
          </el-form-item>
          <el-form-item label="详细说明：" :error="errors.formOverruleType" prop="desc">
            <el-input
              type="textarea"
              @change="changeInput"
              placeholder="必填，请注明有误的节点名称及原因"
              v-model="formOverrule.desc"
            ></el-input>
          </el-form-item>
        </el-form>
        <div></div>
