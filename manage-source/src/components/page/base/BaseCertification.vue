  ...
  <div class="container-admin">
    ...
    <div class="admin-body">
        ...
        <el-col :offset="2" :span="20" style="text-align:right;">
          <el-form :inline="true" :model="searchForm" class="demo-form-inline">
            <el-form-item label="审核状态" v-show="cerActiveName == 'first'">
              <el-select @change="typeChange" v-model="searchForm.authenticationPhaseList" placeholder="审核状态">
      ...
      >
        ...
        <el-table-column prop="authenticationPhase" label="审核状态" :formatter="formatterPhase" width="180">
        </el-table-column>
        <el-table-column prop="latestApproveEndTime" label="截止时间" sortable width="180">
        ...
        <el-table-column width="180" label="操作">
          <template slot-scope="scope">
            <span>
              <el-button
                type="text"
                v-if="scope.row.authenticationPhase == 1"
                @click="handleView(scope.$index, scope.row)"
                >审核</el-button
              >
              <el-button
                type="text"
                v-else-if="scope.row.authenticationPhase == 5"
                @click="handleView(scope.$index, scope.row)"
                >重审</el-button
              >
      ...
      >
        <el-table-column prop="enterpriseName" label="企业名称"> </el-table-column>
        <el-table-column prop="latestApproveTime" label="审核时间" sortable width="180"> </el-table-column>
        <el-table-column prop="latestApproveManagerName" label="审核人" width="180"> </el-table-column>
        <el-table-column width="180" label="操作">
          <template slot-scope="scope">
            <span>
