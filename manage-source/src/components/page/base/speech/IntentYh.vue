<template>
  <div class="speech-tab-pane">
    <div>
      ...
      <el-table @sort-change="sortChange" :data="memberData" style="width: 100%;border-left:1px solid #ebeef5;">
        <el-table-column prop="userName" label="创建用户"> </el-table-column>
        <el-table-column sortable prop="latestApplyTime" width="180" label="更新时间"> </el-table-column>
