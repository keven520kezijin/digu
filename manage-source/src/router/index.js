  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/repository/config/:id/add',
          component: resolve => require(['../components/page/RepositoryAdd.vue'], resolve),
          meta: { title: '添加问答' },
        },
        {
        ...
        },
        {
          ...
          component: resolve => require(['../components/page/RepositoryEditNeo.vue'], resolve),
          meta: { title: '话术库' },
        },
        {
