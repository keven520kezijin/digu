...
var soundVue = new Vue({
  ...
  methods: {
    ...
    use() {
      ...
      // 话术编辑器
        ...
        winOpener.$.utils._speechcraftContent[winOpener.$.utils._flowTypeName].forEach(elem => {
          ...
          let editableTabsName = winOpener.$.utils._speechEditableTabsName;
          if (elem.name === editableTabsName) {
            ...
            winOpener.richEditor.bindEvent(
              winOpener._style,
              /* winOpener.$.utils._speechcraftContentVue.isDisabled*/ false,
            );
          }
        });
      }
    ...
    sortSoundConfigGroup(list) {
      ...
      $.ajax({
        type: 'POST',
        url: baseHost + '/services/sound/sortSoundConfigGroup.json',
        dataType: 'json',
    ...
    querySoundConfigGroupList() {
      $.get(baseHost + '/services/sound/querySoundConfigGroupList.json').then(res => {
        if (res.resultMessageEnum == '0000') {
    ...
    modifySoundConfigGroup(item, index) {
      ...
      if (item.newAdd) {
        ...
        $.ajax({
          type: 'POST',
          url: baseHost + '/services/sound/addSoundConfigGroup.json',
          dataType: 'json',
          contentType: 'application/json',
        ...
        $.ajax({
          type: 'POST',
          url: baseHost + '/services/sound/modifySoundConfigGroup.json',
          dataType: 'json',
          contentType: 'application/json',
          data: JSON.stringify(data),
          async: false,
    ...
    removeSoundConfigGroup() {
      ...
      $.post(
        baseHost + '/services/sound/removeSoundConfigGroup.json?soundConfigGroupId=' + data.soundConfigGroupId,
      ).then(res => {
        if (res.resultMessageEnum == '0000') {
          if (this.activeGroupType == 'speech') {
    ...
    querySoundConfigItemList(item, index, type) {
      ...
      $.ajax({
        type: 'POST',
        url: baseHost + '/services/sound/querySoundConfigItemList.json',
        dataType: 'json',
        contentType: 'application/json',
        data: JSON.stringify(data),
        async: false,
        ...
        if (res.resultMessageEnum == '0000') {
          ...
          soundVue.$nextTick(() => {
            ...
            // 设置音频列表滚动条
            $('.repository-menu-box').niceScroll({
              cursorcolor: '#CCC',
              cursorborder: '0px',
              zindex: 'auto',
              autohidemode: true,
    ...
    modifySoundConfigItem(index, row) {
      ...
      $.ajax({
        type: 'POST',
        url: baseHost + '/services/sound/modifySoundConfigItem.json',
        dataType: 'json',
        contentType: 'application/json',
        data: JSON.stringify(data),
        async: false,
    ...
    removeSoundConfigItemList() {
      ...
      $.ajax({
        type: 'POST',
        url: baseHost + '/services/sound/removeSoundConfigItemList.json',
        dataType: 'json',
        contentType: 'application/json',
        data: JSON.stringify(data),
        async: false,
    ...
    uploadSoundFileList() {
      ...
      $.ajax({
        url: baseHost + '/services/sound/uploadSoundFileList.json',
        type: 'POST',
        cache: false,
        data: oMyForm,
        dataType: 'json',
    ...
    createSoundConfigItemExcelFile() {
      ...
      $.ajax({
        type: 'POST',
        url: baseHost + '/services/file/createSoundConfigItemExcelFile.json',
        dataType: 'json',
        contentType: 'application/json',
        data: JSON.stringify(data),
        async: false,
        ...
        if (res.resultMessageEnum == '0000') {
          window.location.href = baseHost + '/services/file/downloadFile.html?filePath=' + res.returnObject.filePath;
    ...
    importSoundConfigItemExcelFile() {
      ...
      $.ajax({
        url: baseHost + '/services/file/importSoundConfigItemExcelFile.json',
        type: 'POST',
        cache: false,
        data: oMyForm,
        dataType: 'json',
    ...
    handleVideo(index, row) {
      ...
      this.$nextTick(() => {
        ...
        this.viewSource = baseHost + '/services/file/downloadFile.html?filePath=' + encodeURIComponent(row.soundPath);
      });
    },
    //得到文件播放时长
    getFilePlayDuration() {
      return $.get(
        baseHost + '/services/file/getFilePlayDuration.json?filePath=' + encodeURIComponent(this.soundPath),
      ).then(res => {
        if (res.resultMessageEnum == '0000') {
          return res;
        } else if (res.resultMessageEnum == '0001') {
    ...
    percentMusic() {
      ...
      this.getFilePlayDuration().then(res => {
        ...
        this.$refs.w_audio.ontimeupdate = () => {
          ...
          var value =
            this.currentMusic.currentTime && lduration ? (this.currentMusic.currentTime / lduration) * 100 : 0;
