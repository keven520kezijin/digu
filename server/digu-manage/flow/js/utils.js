                            ...
                            if (pathIndex!="-1" && contentIndex!="-1"){
                                ...
                                leftKH.forEach((el)=>{
                                    ...
                                    if (leftKHSplit.length == 2){
                                        ...
                                        let inputStr = '['+leftKHSplit[0]+']'+'<input type="text" id="'+leftKHSplit[0]+'" value="">';
        	...
        	return new Vue({
        	    ...
        	    methods:{
        	    	...
        	    	saveKnowledge(){
        	    		...
        	    		$.ajax({
        	    			type : "POST",
        	    			url : _baseUrl + "/services/speechcraft/modifySpeechcraft.json",
        	    			dataType : "json",
        	    	...
        	    	querySpeechcraftDetail(){
        	    		$.ajax({
        	    			type : "GET",
        	    			url : _baseUrl + '/services/speechcraft/querySpeechcraftDetail.json?speechcraftId=' + speechcraftId,
        	    			dataType : "json",
        	    			contentType : "application/json",
        	    			async: false,		
        	    		}).then((res) => {
        	    	...
        	    	queryKnowledgeGroupList(){
        	    		$.get(_baseUrl + '/services/knowledge/queryKnowledgeGroupList.json?memberId=' + memberId).then((res)=>{
        	    			if(res.resultMessageEnum=='0000'){
        	    				let data = res.returnObject;
        	    				if (data != null) {
        	    	...
        	    	queryAllIndustryList(){
    					$.get(_baseUrl + '/services/intention/queryAllIndustryList.json').then((res)=>{
    						if(res.resultMessageEnum=='0000'){
        	    	...
        	    	saveIntentLevelDesc(){
                        ...
                        $.ajax({
        	    			type : "POST",
                            url: _baseUrl + '/services/speechcraft/modifyIntentionLevelDescription.json',
        	    			dataType : "json",
        	    			contentType : "application/json",
        	    	...
        	    	uploadRecord(id){
                        ...
                        $.ajax({
                            url: _baseUrl + '/services/common/uploadAnnexFile.json',
                            type: 'POST',
                            cache: false,
                            data: formData,
                            dataType: "json",
        	    	...
        	    	downloadRecord(id){
                        ...
                        window.location.href = _baseUrl + '/services/file/downloadFile.html?filePath=' + filePath;
					...
					handlePlaying(){
                        ...
                        $.ajax({
                            type : "POST",
                            url : _baseUrl +"/services/speechcraft/testListen.json",
                            dataType : "json",
                            contentType : "application/json",
                            ...
                            success : function(data) {
                                ...
                                if (data.resultMessageEnum == "0000") {
                                    self.viewSource = _baseUrl + "/services/file/downloadFile.html?filePath="+data.returnObject.joinUrl;
        	...
        	return new Vue({
        	    ...
        	    methods:{
        	    	...
        	    	queryIntentionTemplateList:function(){
    					...
    					$.ajax({
    						type : 'POST',
    						url : _baseUrl + '/services/intention/queryIntentionSpeechcraftList.json',
    						dataType : 'json',
    						contentType : 'application/json',
